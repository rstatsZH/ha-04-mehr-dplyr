...
**Falls diese Übungen zu herausfordernd sind, kannst du diese auch überspringen. Wir werden uns die Lösungen in der nächsten Woche anschauen. Wichtig ist jedoch, dass du das Kapitel liest, dir Fragen notierst und diese in den Slack Channel schreibst.**
...
4. Nutze die Funktion `mutate()` in Kombination mit der Funktion `case_when()` um eine neue Spalte mit dem Namen "Veraenderung" zu erstellen. Diese Spalte soll angeben ob die Anzahl Schüler_innen im jeweiligen Jahr zugenommen oder abgenommen habt. 
